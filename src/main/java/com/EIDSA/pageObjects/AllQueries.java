...
public class AllQueries extends AbstractComponent{
	static WebDriver driver;
	public AllQueries(WebDriver driver)
	{
		super(driver);
		this.driver=driver;
	...
	@FindBy(xpath = "//body[1]/div[1]/div[1]/div[1]/div[1]/nav[1]/div[1]/ul[1]/li[3]/ul[1]/li[10]/ul[1]/li[3]/a[1]/span[1]")
	@CacheLookup
	WebElement AllQueries2;
